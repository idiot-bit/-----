...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="start")
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="help_command")
...
async def add_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="add_user")
...
async def remove_user(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="remove_user")
...
async def userlist(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="userlist")
...
async def ping(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="ping")
...
async def rules(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="rules")
...
async def reset_caption(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="reset_caption")
...
async def reset_channel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="reset_channel")
...
async def reset(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="reset")
...
async def set_channel_id(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        # Safely update just the 'status'
        USER_STATE.setdefault(user_id, {}).update({"status": "waiting_channel"})

        # Build Bot Admin button if link exists
        bot_admin_url = CONFIG.get("bot_admin_url")
        keyboard = []

        if bot_admin_url:
            keyboard = [[InlineKeyboardButton("👨‍💻 Bot Admin", url=bot_admin_url)]]
        ...
        await notify_owner_on_error(context.bot, e, where="set_channel_id")
...
async def set_caption(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        raise RuntimeError("Manual test error inside set_caption")
        ...
        await notify_owner_on_error(context.bot, e, where="set_caption")
...
async def user_viewsetup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="user_viewsetup")
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="handle_photo")
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="handle_document")
...
async def auto4_message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="auto4_message_handler")
...
async def process_auto4_delayed(context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="process_auto4_delayed")
...
async def send_auto4_apks(apks, key, context: ContextTypes.DEFAULT_TYPE, countdown_msg, setup_type):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="send_auto4_apks")
...
async def process_method1_apk(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="process_method1_apk")
...
async def ask_to_share(update: Update):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="ask_to_share")
...
async def process_method2_apk(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="process_method2_apk")
...
async def start_method2_countdown(user_id: int, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="start_method2_countdown")
...
async def method2_send_to_channel(user_id, context):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="method2_send_to_channel")
...
async def method2_convert_quote(user_id, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="method2_convert_quote")
...
async def method2_convert_mono(user_id, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="method2_convert_mono")
...
async def method2_edit_caption(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="method2_edit_caption")
...
async def method2_show_preview(user_id, context):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="method2_show_preview")
...
async def method2_back_fullmenu(user_id, context):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="method2_back_fullmenu")
...
async def send_user_stats_report(context: ContextTypes.DEFAULT_TYPE, hours=6):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="send_user_stats_report")
...
async def reset_stats(hours=6):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="reset_stats")
...
async def schedule_stat_reports(application: Application):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="schedule_stat_reports")
...
async def auto_recaption(user_id, context):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="auto_recaption")
...
async def auto_last_caption(user_id, context):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="auto_last_caption")
...
async def last_caption_key(user_id, context):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="last_caption_key")
...
async def erase_all_session(user_id, context):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="erase_all_session")
...
async def settings_panel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="settings_panel")
...
async def handle_settings_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="handle_settings_callback")
...
async def handle_backup_restore(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="handle_backup_restore")
...
async def handle_backup_restore_from_document(file, context, user_id, filename):
    try:
        ...
        try:
            # 1. Download the ZIP to disk
            await file.download_to_drive(zip_path)
    
            # 2. Extract contents to working directory
            ...
            # 4. Reload restored state/config into memory
            load_state()
        ...
        await notify_owner_on_error(context.bot, e, where="handle_backup_restore_from_document")
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="handle_text")
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await query.message.edit_text("🔁 Callback received: " + data)
        ...
        await notify_owner_on_error(context.bot, e, where="handle_callback")
...
async def send_broadcast(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="send_broadcast")
...
async def auto_handle_channel_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await notify_owner_on_error(context.bot, e, where="auto_handle_channel_post")
