        ...
        if not key:
            ...
            await update.message.reply_text(
                text=(
                    "<pre>"
                    "<b>▌ KEY MODE ACTIVE ▌</b>\n"
                    "▶<b>Send your Key Now</b>\n"
                    "▶<b>Used for Mods , Loaders</b>\n"
                    "────────────────────"
                    "</pre>"
                ),
                parse_mode="HTML"
...
async def ask_to_share(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await context.bot.send_message(
            ...
            text=(
                "<b>┌─[ POST CONFIRMATION ]</b>\n"
                "<pre>"
                "│ Ready to share your content?\n"
                "│ \n"
                "│ ▶ If yes, it will be posted now.\n"
                "│ ▶ If no, it will be discarded.\n"
                "└──────────────────────────"
                "</pre>"
            ),
            parse_mode="HTML",
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        # Safely ignore updates without message or text
