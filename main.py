...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        if data == "share_yes":
            ...
            # Stat tracking
            USER_STATE[user_id]["hourly_apks"] = USER_STATE[user_id].get("hourly_apks", 0) + 1
            USER_STATE[user_id]["daily_apks"] = USER_STATE[user_id].get("daily_apks", 0) + 1
            USER_STATE[user_id]["weekly_apks"] = USER_STATE[user_id].get("weekly_apks", 0) + 1
            USER_STATE[user_id]["monthly_apks"] = USER_STATE[user_id].get("monthly_apks", 0) + 1
