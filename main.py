    ...
    try:
        ...
        if data == "share_yes":
            ...
            try:
                ...
                # Fix channel ID for View Post link
                channel_id = str(pending["channel"]).removeprefix("-100")
                keyboard = [
                    [InlineKeyboardButton("🔗 View Post", url=f"https://t.me/c/{channel_id}/{result.message_id}")],
